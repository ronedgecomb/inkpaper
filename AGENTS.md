...
- Compatibility covers Python 3.12 or newer and Gradio 6.20 through 6.x. Do not raise the `gradio<7` cap without an explicit review of the theme tokens and the DOM-level CSS workarounds against the new major version.
