...
[![Python](https://img.shields.io/badge/python-3.12%2B-7288a7)](https://www.python.org/)
...
Inkpaper supports Python 3.12 or newer and Gradio 6.20 through 6.x. The dependency is capped below the next major version: when Gradio 7 arrives, the theme tokens and DOM-level CSS workarounds must be reviewed against it before the cap is lifted.
